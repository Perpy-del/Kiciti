        ...
        <div className='main_container'>
            ...
            <div className='input_field'>
                ...
                <div className='input_field'>
                    ...
                    <select onChange={e=>setCountry(e.target.value)} type="text" id='country' name='country' onKeyUp="filledInput()">
                ...
                <div className='input_field'>
                    ...
                    <input onChange={e=>setDOB(e.target.value)} type="text" id='dob' placeholder='Date of Birth(dd/mm/yyyy)' onKeyUp="filledInput()"/>
                </div>
                {error&&dob.date<=0?
                ...
                <div className='input_field'>
                    ...
                    <select onChange={e=>setGender(e.target.value)} type="text" id='gender' onKeyUp="filledInput()">
